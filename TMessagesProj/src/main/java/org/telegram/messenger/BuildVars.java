...
public class BuildVars {
    ...
    public static int APP_ID = 18555; //obtain your own APP_ID at https://core.telegram.org/api/obtaining_api_id
    public static String APP_HASH = "5c1cfc869c77539ef3fffe6b38c1120f"; //obtain your own APP_HASH at https://core.telegram.org/api/obtaining_api_id
    public static String HOCKEY_APP_HASH = "";
    public static String HOCKEY_APP_HASH_DEBUG = "";
    public static String GCM_SENDER_ID = "773423251636";
    public static String SEND_LOGS_EMAIL = "keremsoft42@gmail.com";
